...
Ainda não implementado (ver [docs/plano-implementacao.md](docs/plano-implementacao.md)): CRUD de usuários no admin, gerenciamento de feature flags (UI), verificação de e-mail/reset de senha com envio real, reenvio de convite, papéis para organizações do tipo EMPRESA/MANTENEDOR/PARCEIRO.
